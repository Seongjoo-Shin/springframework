...
<div class="card m-2">
   ...
   <div class="card-body">
      <div class="card m-2">
         ...
         <div class="card-body">
            <div class="m-2"><a href="${pageContext.request.contextPath}/ch02/method?bkind=free&bno=5" class="btn btn-info btn-sm">GET방식</a></div>
            <form class="m-2" method="get" action="${pageContext.request.contextPath}/ch02/method">
            	...
            	bno : <input type="text" name="bno" value="1" class="mt-2"/><br/>
            	<input type="submit" value="GET방식" class="btn btn-info btn-sm mt-2"/>
            </form>
            ...
            <form class="m-2" method="post" action="${pageContext.request.contextPath}/ch02/method">
            	bkind : <input type="text" name="bkind" value="freedom" /><br/>
            	bno : <input type="text" name="bno" value="100" class="mt-2"/><br/>
            	<input type="submit" value="POST방식" class="btn btn-info btn-sm mt-2"/>
            </form>
            ...
            <%-- a태그는 put, delete 방식을 사용할 수 없음 --%>
         </div>
         <script>
            function requestGet() {
               	//location.href="${pageContext.request.contextPath}/ch02/method?bkind=hi&bno=100";
            	$.ajax({
                  url:"${pageContext.request.contextPath}/ch02/method",
                  method: "GET",
                  //data: "bkind=free&bno=1"
                  data: {bkind:"get", bno:1}
               })
               .done((data) => {});
            }
